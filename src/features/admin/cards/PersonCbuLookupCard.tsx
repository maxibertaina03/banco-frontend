...
import { findCentralPersonByCbu } from "../../personas/api/personas.api";
import type { CentralPersonLookupResult } from "../../../lib/api";

interface PersonCbuLookupCardProps {
  environment: "test" | "prod";
}

export const PersonCbuLookupCard = memo(function PersonCbuLookupCard({ environment }: PersonCbuLookupCardProps) {
